#include<stdio.h>
#include<stdlib.h>
int max[10][10],need[10][10],alloc[10][10],avail[10],completed[10],request[10],sseq[10],ch1;
int p,q,r,i,j,k,new;
int safeseq();
int main()
{
...
printf("\n\n enter the allocation for each processs");
for(i=0;i<p;i++)
{
printf("\n for process %d",i+1);
for(j=0;j<r;j++)
...
if(ch1==0)
{
printf("the sysytem is not in safe state\n");
exit(0);
}
else
{
...
{
printf("\n the system is not in safe sate\n");
return 0;
}
}
